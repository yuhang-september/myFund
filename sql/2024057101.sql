...
(
    `trade_request_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
    `fund_code`           char(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci  NOT NULL,
    `application_amount`  decimal(10, 2)                                            NOT NULL,
    `status`              int                                                       NOT NULL,
    `share`               decimal(10, 2)                                            NULL DEFAULT NULL,
    `create_time`         datetime                                                  NOT NULL,
    `last_update_time`    datetime                                                  NOT NULL,
    `type`                char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci  NOT NULL,
    'trade_account_id'    char(49) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
    `payment_channel`           char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci  NOT NULL,
    PRIMARY KEY (`trade_request_id`) USING BTREE,
    INDEX `trade_request_idx1` (`trade_request_id` ASC) USING BTREE,
